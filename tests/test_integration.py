...
class TestFirmwareQuery:
    """Hardware-gated test for firmware.query() over a real PPK2."""

    def test_query_shape(self):
        from ppk2 import firmware
        from ppk2.transport import resolve_device
        ...
        assert info.bootloader_version > 0
        assert info.application_version > 0
